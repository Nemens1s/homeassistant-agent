...
register(
    ToolDefinition(
        ...
        description=(
            ...
            "'what devices are in <room>' / 'what's in <room>' / 'what do I have' — a clean "
            "device-level view without noisy entities. "
            "No args → all devices. area='Kitchen' → devices in that one room. name='roborock' → search by name. "
